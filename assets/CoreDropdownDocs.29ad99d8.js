...
`]}})}}),e(c.Preview,{get children(){return e($,{})}}),e(c.Code,{get children(){return e(s.pre,{get children(){return e(s.code,{className:"hljs language-jsx",get children(){return[e(s.span,{className:"hljs-keyword",children:"import"}),` {\r
...
`]}})}})}})]}}),a),n(a,e(s.h2,{children:"Components"}),null),n(a,e(s.p,{get children(){return["Dropdowns are made up of a wrapping ",e(s.code,{children:"Dropdown"})," component, a ",e(s.code,{children:"Toggle"}),` that\r
...
render prop API or a hook depending on preference.`]}}),null),n(a,e(s.h3,{children:"Dropdown"}),null),n(a,e(s.p,{get children(){return["The ",e(s.code,{children:"Dropdown"}),` component is the non-presentational orchestrator of the dropdown state.\r
...
<Dropdown>
`]}})}}),null),n(a,e(s.h3,{children:"Toggle"}),null),n(a,e(s.p,{get children(){return["The ",e(s.code,{children:"Toggle"}),` is an interactive element (usually a button) that opens the dropdown menu.\r
...
`]}})}})}})]}}),null),n(a,e(s.h3,{children:"Menu"}),null),n(a,e(s.p,{get children(){return["The dropdown ",e(s.code,{children:"Menu"}),` provides an overlay that is positioned next to the dropdown toggle.\r
