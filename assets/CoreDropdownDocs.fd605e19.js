import{g as f,v as n,c as e,t as p,n as D,o as b,Y as v,j as g,aa as y}from"./index.5ae66943.js";import{M as j}from"./index.e525610a.js";import{E as c,T as u}from"./Example.7f10c31b.js";import{c as h,a as k,b as _}from"./Dropdown.3ea38d7e.js";import{T as w}from"./Tabs.91fc900a.js";import"./Card.c15ac305.js";import"./store.2178eaab.js";const T=p('<div class="dropdown-menu"></div>'),M=p("<span></span>"),x=p('<div class="d-flex justify-content-center"></div>'),P=l=>{const[r,o]=k({flip:!0,offset:[0,4]});return(()=>{const s=T.cloneNode(!0);return D(s,r,!1,!0),n(s,e(h.Item,{class:"dropdown-item",children:"Item 1"}),null),n(s,e(h.Item,{class:"dropdown-item",children:"Item 2"}),null),b(t=>{const a=l.role,d=o.show;return a!==t._v$&&v(s,"role",t._v$=a),d!==t._v$2&&s.classList.toggle("show",t._v$2=d),t},{_v$:void 0,_v$2:void 0}),s})()},B=l=>{const[r]=_();return e(y,g(r,{class:"btn btn-primary dropdown-toggle",get children(){return l.children}}))},I=l=>e(h,{get show(){return l.show},get onToggle(){return l.onToggle},get children(){const r=M.cloneNode(!0);return n(r,e(B,{get children(){return l.title}}),null),n(r,e(P,{get role(){return l.role}}),null),r}});function $(){const[l,r]=f(!1);return(()=>{const o=x.cloneNode(!0);return n(o,e(I,{get show(){return l()},onToggle:s=>r(s),get title(){return`${l()?"Close":"Open"} Dropdown`}})),o})()}const C=p('<p class="lead"></p>'),S=p('<div class="row gy-5 pt-3"><div></div><div></div></div>');function H(l={}){const{wrapper:r}=Object.assign({},j(),l.components);return r?e(r,g(l,{get children(){return e(o,{})}})):o();function o(){const s=Object.assign({h1:"h1",p:"p",code:"code",ul:"ul",li:"li",pre:"pre",span:"span",h2:"h2",h3:"h3",strong:"strong",em:"em"},j(),l.components);return h||i("Dropdown",!1),h.Menu||i("Dropdown.Menu",!0),h.Toggle||i("Dropdown.Toggle",!0),c||i("Example",!1),c.Code||i("Example.Code",!0),c.Intro||i("Example.Intro",!0),c.Preview||i("Example.Preview",!0),[e(s.h1,{children:"Dropdown (core)"}),`
...
`]}})}}),null),t})()]}}function i(l,r){throw new Error("Expected "+(r?"component":"object")+" `"+l+"` to be defined: you likely forgot to import, pass, or provide it.")}export{H as default};
