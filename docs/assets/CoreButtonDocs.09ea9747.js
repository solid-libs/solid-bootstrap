import{t as h,c as e,m,i,ai as t}from"./vendor.6a5ca7bc.js";import{x as o}from"./index.bf078b0c.js";import{E as n}from"./Example.767bbcc8.js";const u=h('<p class="lead"></p>'),p=h("<br>"),N=h('<div class="row gy-5 pt-3"></div>');function y(r={}){const{wrapper:l}=Object.assign({},o(),r.components);return l?e(l,m(r,{get children(){return e(d,{})}})):d();function d(){const s=Object.assign({h1:"h1",p:"p",pre:"pre",code:"code",span:"span",ul:"ul",li:"li",h3:"h3",h2:"h2"},o(),r.components);return n||c("Example",!1),n.Code||c("Example.Code",!0),n.Intro||c("Example.Intro",!0),n.Preview||c("Example.Preview",!0),[e(s.h1,{children:"Button (core)"}),`
`,(()=>{const a=u.cloneNode(!0);return i(a,e(s.p,{children:`An abstract button component for creating accessible buttons regardless of the HTML\r
element used to render it.`})),a})(),`
`,(()=>{const a=N.cloneNode(!0);return i(a,e(n,{title:"Basic Example",get children(){return[e(n.Preview,{get children(){return e(t,{children:"I'm a Button"})}}),e(n.Code,{get children(){return e(s.pre,{get children(){return e(s.code,{className:"hljs language-jsx",get children(){return[e(s.span,{className:"hljs-keyword",children:"import"})," { ",e(s.span,{className:"hljs-title hljs-class",children:"Button"})," } ",e(s.span,{className:"hljs-keyword",children:"from"})," ",e(s.span,{className:"hljs-string",children:'"solid-bootstrap-core"'}),`;\r
\r
...
`]}})}})}})]}}),null),i(a,e(n,{get children(){return[e(n.Intro,{get children(){return[e(s.p,{get children(){return["Not very impressive on its own, but ",e(s.code,{children:"Button"}),` does come with a few conveniences\r
...
\r
\r
`,e(s.span,{className:"hljs-keyword",children:"function"})," ",e(s.span,{className:"hljs-title hljs-function",children:"CompanyButton"}),"(",e(s.span,{className:"hljs-params",children:"props"}),`) {\r
  `,e(s.span,{className:"hljs-keyword",children:"const"})," [ariaButtonProps, { ",e(s.span,{className:"hljs-attr",children:"tagName"}),": ",e(s.span,{className:"hljs-title hljs-class",children:"Tag"})," }] = ",e(s.span,{className:"hljs-title hljs-function",children:"useButtonProps"}),`(props);\r
\r
...
\r
<div className=`,e(s.span,{className:"hljs-string",children:'"space-x-4"'}),`>\r
...
`,e(s.pre,{get children(){return e(s.code,{className:"hljs language-jsx",get children(){return[e(s.span,{className:"hljs-keyword",children:"import"})," { ",e(s.span,{className:"hljs-title hljs-class",children:"Button"})," } ",e(s.span,{className:"hljs-keyword",children:"from"})," ",e(s.span,{className:"hljs-string",children:'"solid-bootstrap-core"'}),`;\r
...
\r
`,e(s.span,{className:"hljs-keyword",children:"function"})," ",e(s.span,{className:"hljs-title hljs-function",children:"StyledButton"}),"(",e(s.span,{className:"hljs-params",children:"props"}),`) {\r
  `,e(s.span,{className:"hljs-keyword",children:"return"}),` (\r
    `,e(s.span,{className:"xml",get children(){return e(s.span,{className:"hljs-tag",get children(){return["<",e(s.span,{className:"hljs-name",children:"Button"}),`\r
      ...
      `,e(s.span,{className:"hljs-attr",children:"className"}),"=",e(s.span,{className:"hljs-string",children:"{clsx("}),`\r
        `,e(s.span,{className:"hljs-attr",children:"props.className"}),`,\r
...
`]}})}})]}}function c(r,l){throw new Error("Expected "+(l?"component":"object")+" `"+r+"` to be defined: you likely forgot to import, pass, or provide it.")}export{y as default};
