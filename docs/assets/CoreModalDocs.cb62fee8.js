import{t as h,am as w,j as o,i as c,c as s,ai as p,s as j,an as N,d as y,m as k}from"./vendor.6a5ca7bc.js";import{x as g}from"./index.bf078b0c.js";import{E as t}from"./Example.767bbcc8.js";const x=h('<div class="modal-dialog modal-dialog-centered"><div class="modal-content"><div class="modal-header"><h4 id="modal-1-label">Alert!</h4></div><div class="modal-body"><p>Some important content!</p></div><div class="modal-footer"></div></div></div>'),$=h("<div></div>"),u=h('<div class="modal-backdrop show"></div>'),M=h('<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h4 id="modal-label">Text in a modal</h4></div><div class="modal-body"><p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula.</p></div></div></div>'),_=h('<div><button class="btn btn-primary">Open modal</button><div class="pt-3">Click to get the full Modal experience!</div></div>'),C=h("<p></p>"),S=()=>{const[l,n]=o(!1);return(()=>{const r=$.cloneNode(!0);return c(r,s(p,{className:"btn btn-primary",onClick:()=>n(!0),children:"Open Modal"}),null),c(r,s(N,{get show(){return l()},"aria-labelledby":"modal-1-label",onHide:()=>n(!1),renderBackdrop:a=>(()=>{const e=u.cloneNode(!0);return j(e,a,!1,!1),e})(),className:"modal d-block pe-none",get children(){const a=x.cloneNode(!0),e=a.firstChild,i=e.firstChild,d=i.nextSibling,b=d.nextSibling;return c(b,s(p,{onClick:()=>n(!1),className:"btn btn-secondary float-right",children:"Close"})),a}}),null),r})()};let v=(l,n)=>l+Math.floor(Math.random()*(n-l));const E=()=>(()=>{const l=M.cloneNode(!0),n=l.firstChild,r=n.firstChild,a=r.nextSibling;return a.firstChild,c(a,s(f,{}),null),y(e=>{const i=`${v(5,20)}%`,d=`${v(20,60)}%`;return i!==e._v$&&l.style.setProperty("margin-top",e._v$=i),d!==e._v$2&&l.style.setProperty("margin-left",e._v$2=d),e},{_v$:void 0,_v$2:void 0}),l})(),f=()=>{const[l,n]=o(!1);return[(()=>{const r=_.cloneNode(!0),a=r.firstChild;return a.$$click=()=>n(!0),r})(),C.cloneNode(!0),s(N,{class:"modal d-block pe-none",get show(){return l()},onHide:()=>n(!1),renderBackdrop:r=>(()=>{const a=u.cloneNode(!0);return a.style.setProperty("z-index","1055"),j(a,r,!1,!1),a})(),"aria-labelledby":"modal-label",get children(){return s(E,{})}})]};w(["click"]);const P=h('<p class="lead"></p>'),B=h('<div class="row gy-5 pt-3"><div></div></div>');function D(l={}){const{wrapper:n}=Object.assign({},g(),l.components);return n?s(n,k(l,{get children(){return s(r,{})}})):r();function r(){const a=Object.assign({h1:"h1",p:"p",code:"code",ul:"ul",li:"li",pre:"pre",span:"span"},g(),l.components);return t||m("Example",!1),t.Code||m("Example.Code",!0),t.Intro||m("Example.Intro",!0),t.Preview||m("Example.Preview",!0),[s(a.h1,{children:"Modals (core)"}),`
