...
export interface CloseButtonProps extends JSX.ButtonHTMLAttributes<HTMLButtonElement> {
...
const CloseButton = (p: CloseButtonProps) => {
  const [local, props] = splitProps(mergeProps(defaultProps, p), ["className", "variant"]);
