...
const MenuButton = (props: ComponentProps<typeof Button>) => (
  <Button {...props} class={clsx(props.class, styles.MenuButton, "p-0 d-md-none ms-auto")} />
);

const SidePanel = (props: ComponentProps<"div">) => (
  <div {...props} class={clsx(props.class, styles.SidePanel, "d-flex flex-column")} />
);

const OverflowWrapper = (props: ComponentProps<"div">) => (
  <div {...props} class={clsx(props.class, styles.OverflowWrapper)} />
);

const TableOfContents = (props: ComponentProps<"nav">) => (
  <nav {...props} class={clsx(props.class, styles.TableOfContents, "pt-2 pb-4")} />
);

const TocLink = (props: ComponentProps<typeof Nav.Link>) => (
  <Nav.Link {...props} class={clsx(props.class, styles.TocLink)} />
);

const TocSubLink = (props: ComponentProps<typeof TocLink>) => (
  <TocLink {...props} class={clsx(props.class, styles.TocSubLink)} />
);
  ...
  return (
    <>
      <TocLink
        ...
        class={clsx("js-search-toc-item", active() && "js-search-active")}
      >
        {props.heading}
      </TocLink>
