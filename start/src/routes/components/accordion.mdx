...
import Api from "../../api/AccordionAPI";

<GithubSource name="components/accordion.mdx" />
# Accordion
<div class="lead">
...
<div class="row gy-5 pt-3">
  ...
  <Example title="Fully Collapsed State" >
    <Example.Intro>
      If you want your `Accordion` to start in a fully-collapsed state, then simply dont pass in a `defaultActiveKey` prop to `Accordion`.
    </Example.Intro>
    <Example.Preview>
      <Accordion>
        <Accordion.Item eventKey="0">
