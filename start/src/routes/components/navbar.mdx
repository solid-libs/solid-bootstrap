...
<GithubSource name="components/navbar.mdx" />
# Navbars
...
<div class="row gy-5 pt-3">
  ...
  <Example title="Brand">
    ...
    <Example.Preview>
      ...
      <Navbar bg="dark">
        <Container>
          <Navbar.Brand href="#">
            <img alt="" src={import.meta.env.BASE_URL + "logo.svg"} width="30" height="30" class="d-inline-block align-top"/>
          </Navbar.Brand>
        </Container>
      </Navbar>
      <br />
  ...
  <Example title="Responsive behaviors">
    ...
    <Alert variant="warning" class="mt-3">Watch out! You <strong>need</strong> to provide a breakpoint value to <code>expand</code> inorder for the Navbar to collapse at all.</Alert>
  </Example>
