...
<GithubSource name="forms/form-text.mdx" />
# Form text
...
<table class="bg-white mb-0 table table-striped table-bordered">
  ...
  <tbody>
    <tr><td>ref </td><td><div></div></td><td></td><td><div><p>The FormText <code>ref</code> will be forwarded to the underlying element. Unless the FormText is rendered <code>as</code> a composite component, it will be a DOM node, when resolved.</p></div></td></tr>
