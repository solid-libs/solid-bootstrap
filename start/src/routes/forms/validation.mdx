...
import { Example1 } from "../../api/FormValidationExamples";
import Example from "../../components/Example";
import GithubSource from "../../components/GithubSource";
import BadgeApi from "../../api/BadgeApi";

<GithubSource name="forms/validation.mdx" />
# Validation
...
<div class="row gy-5 pt-3">
  ...
  <Alert variant="info">
    It's often beneficial to handle form validation via a library. In those cases, `isValid`
