...
<div class="row gy-5 pt-3">
  ...
  <Example title="Header and Footer">
    ...
    <Example.Preview>
      ...
      <div className="mt-4 mb-3">A `<CardHeader>` can be styled by passing a heading element through the `<as>` prop</div>
      <Card>
      ...
      <div className="mt-4 mb-3">More examples</div>
      <Card>
      ...
      <Card className="text-center mt-4" style={{ "max-width": '28rem' }}>
        <Card.Header>Featured</Card.Header>
        <Card.Body>
          <Card.Title>Special title treatment</Card.Title>
          <Card.Text>
