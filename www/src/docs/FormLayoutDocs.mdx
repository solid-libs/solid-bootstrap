...
<div class="row gy-5 pt-3">
  ...
  <Example title="Form grid">
    ...
    <Example.Preview>
      <Form>
        ...
        <Form.Group class="mb-3" controlId="formGridAddress1">
          <Form.Label>Address</Form.Label>
          <Form.Control placeholder="1234 Main St" />
        </Form.Group>

        <Form.Group class="mb-3" controlId="formGridAddress2">
        ...
        <Form.Group class="mb-3" id="formGridCheckbox">
  ...
  <Example title="Horizontal form">
    ...
    <Example.Preview>
      <Form>
        <Form.Group as={Row} class="mb-3" controlId="formHorizontalEmail">
        ...
        <Form.Group as={Row} class="mb-3" controlId="formHorizontalPassword">
          <Form.Label column sm={2}>
            Password
          </Form.Label>
          <Col sm={10}>
        ...
        <Form.Group as={Row} class="mb-3" controlId="formHorizontalCheck">
...
<table class="bg-white mb-0 table table-striped table-bordered">
  ...
  <tbody>
    <tr><td>ref </td><td><div></div></td><td></td><td><div><p>The FormGroup <code>ref</code> will be forwarded to the underlying element. Unless the FormGroup is rendered <code>as</code> a composite component, it will be a DOM node, when resolved.</p></div></td></tr>
