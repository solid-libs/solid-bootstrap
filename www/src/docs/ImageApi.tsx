const ImageApi = () => (
  <div className="mt-5">
    <h2>API</h2>
    <h3>Image</h3>
    <code>import Image from 'solid-bootstrap/Image'</code>
      ...
      <table class="bg-white mb-0 table table-striped table-bordered">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <div>
                <p>Sets image as fluid image.</p>
              </div>
            </td>
          </tr>
          <tr>
            <td class="font-monospace">rounded </td>
            <td class="font-monospace">
              <div>boolean</div>
            </td>
            <td>
            ...
            <td>
              <div>
                <p>Sets image shape as rounded.</p>
              </div>
            </td>
          </tr>
          <tr>
            <td class="font-monospace">roundedCircle </td>
            <td class="font-monospace">
              <div>boolean</div>
            </td>
            <td>
            ...
            <td>
              <div>
                <p>Sets image shape as circle.</p>
              </div>
            </td>
          </tr>
          <tr>
            <td class="font-monospace">thumbnail </td>
            <td class="font-monospace">
              <div>boolean</div>
            </td>
            <td>
            ...
            <td>
              <div>
                <p>Sets image shape as thumbnail.</p>
              </div>
            </td>
          </tr>
          <tr>
