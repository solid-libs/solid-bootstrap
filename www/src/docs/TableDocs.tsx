...
export const TableDocs: Component = () => {
  return (
    <div class="row gy-4">
      ...
      <div>
        <Card>
          <Card.Header>Striped, Bordered, Hover</Card.Header>
          <Card.Body>
        ...
        <Card>
          <Card.Header>Small Table</Card.Header>
          <Card.Body>
        ...
        <Card>
          <Card.Header>Dark Table</Card.Header>
          <Card.Body>
        ...
        <Card>
          <Card.Header>Breakpoint specific</Card.Header>
          <Card.Body>
            <div>
              <Table responsive="sm">
                <thead>
