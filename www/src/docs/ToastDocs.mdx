...
<HolderJSRefresh />
<GithubSource name="ToastDocs.mdx" />
# Toasts
    ...
    <Example.Preview>
      <Row>
        <Col md={6} className="mb-2">
          <Button onClick={() => setShow1((s) => !s)} className="mb-2">Toggle Toast <strong>with</strong> Animation</Button>
        ...
        <Col md={6} className="mb-2">
          <Button onClick={() => setShow2((s) => !s)} className="mb-2">Toggle Toast <strong>without</strong> Animation</Button>
          <Toast
            show={show2()}
  ...
  <Example title="Contextual variations">
    ...
    <Example.Preview>
      {[
        ...
        <Toast className="d-inline-block m-2" bg={variant.toLowerCase()}>
          <Toast.Header>
            <img
              src="holder.js/20x20?text=%20"
              className="rounded me-2"
